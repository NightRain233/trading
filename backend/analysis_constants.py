...
# Confirmed MACD divergence. These thresholds are deliberately conservative:
# divergence is supporting evidence and never grants buy/sell permission by itself.
MACD_DIVERGENCE_DAILY_LEFT = 3
MACD_DIVERGENCE_DAILY_RIGHT = 3
MACD_DIVERGENCE_DAILY_MIN_GAP = 10
MACD_DIVERGENCE_DAILY_MAX_GAP = 60
MACD_DIVERGENCE_DAILY_TTL = 10
MACD_DIVERGENCE_DAILY_PRICE_PCT = 0.01
MACD_DIVERGENCE_DAILY_ATR_MULTIPLIER = 0.5
MACD_DIVERGENCE_DAILY_DIF_NORMALIZED = 0.0002
MACD_DIVERGENCE_DAILY_DIF_ALIGNMENT = 2

MACD_DIVERGENCE_WEEKLY_LEFT = 2
MACD_DIVERGENCE_WEEKLY_RIGHT = 2
MACD_DIVERGENCE_WEEKLY_MIN_GAP = 4
MACD_DIVERGENCE_WEEKLY_MAX_GAP = 26
MACD_DIVERGENCE_WEEKLY_TTL = 4
MACD_DIVERGENCE_WEEKLY_PRICE_PCT = 0.02
MACD_DIVERGENCE_WEEKLY_ATR_MULTIPLIER = 0.5
MACD_DIVERGENCE_WEEKLY_DIF_NORMALIZED = 0.0002
MACD_DIVERGENCE_WEEKLY_DIF_ALIGNMENT = 1
